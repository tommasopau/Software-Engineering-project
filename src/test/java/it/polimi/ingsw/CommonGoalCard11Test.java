...
public class CommonGoalCard11Test {
    ...
    void CommonGoalCard11Test() throws RowAndColumnNotFoundException {
        ...
        CommonGoalCard11 cardTest = new CommonGoalCard11(3);

        assertEquals(false, cardTest.commonGoalAchieved(bookshelf));
    }

    @Test
    public void commonGoalCard11CompletedTest() throws RowAndColumnNotFoundException {
        Bookshelf bookshelf = new Bookshelf();
